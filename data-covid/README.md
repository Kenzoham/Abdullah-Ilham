...
# Building & Testing RESTful API dengan Laravel

Disini saya akan melakukan praktikum Mengenai Restful API menggunakan Laravel,
pertama - tama saya akan memperkenalkan tools - tools yang saya gunakan yaitu:
- Xampp, digunakan untuk proses server local
- VSCODE, digunakan untuk mengetikan code
- Composser, digunakan untuk membuat laravel
- Laravel, digunakan untuk proses pembuatan Restful APi
- PostMan, digunakan untuk melakukan testing end-point
